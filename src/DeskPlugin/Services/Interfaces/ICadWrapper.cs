...
namespace Services.Interfaces
{
    ...
    public interface ICadWrapper
    {
        ...
        /// </summary>
        /// <param name="planeType"> Плоскость, в которой необходимо построить прямоугольник.
        /// </param>
        ...
        /// <param name="cuttingByExtrusion"> Показывает, выполнять ли вырезание выдавливанием
        /// (данная операция применяется в некоторых САПР для удаления объема внутри другого
        /// 3D-тела).</param>
        /// <param name="isPositiveDirection"> Показывает, в каком направлении выполнять
        /// операцию выдавливания (по умолчанию выполняется в положительном направлении).</param>
